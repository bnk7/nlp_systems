"""Simple Web interface to spaCy entity recognition and dependency parsing
...
def index():
    if request.method == 'GET':
        ...
        return render_template('result.html', markup=markup_paragraphed, dep_graph=doc.get_parse_graph(),
...
def index_post():
    ...
    for line in markup.split('\n'):
        if line.strip() == '':
            ...
            markup_paragraphed += line
    return render_template('result2.html', markup=markup_paragraphed, dep_graph=doc.get_parse_graph(),
                           dep_table=doc.get_parse_table())
